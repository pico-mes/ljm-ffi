 ...
 */
function linuxHelperCheckLJMVersion(libLocation, libraryName, ljmVersion) {
...
var checkLJMLibForVersion = {
    ...
    'win32': function checkWin32LibraryPath(libLocation, ljmVersion) {
        ...
        try {
            ...
            console.log('Error Executing wmic to collect LabJackM.dll version', err);
            console.log('Library Path', libLocation);
